...
function id_legalitasperusahaan(){
	$CI 	=& get_instance();			
	$reg 	= "";
	
	$CI->db->select('id_legalitasperusahaan');
	$CI->db->from('legalitasperusahaan');
	$CI->db->order_by('id_legalitasperusahaan', 'desc');
	$CI->db->limit(1);
	$q_reg = $CI->db->get();
...
/* End of file myapp_helper.php */
/* Location: ./application/helpers/myapp_helper.php */