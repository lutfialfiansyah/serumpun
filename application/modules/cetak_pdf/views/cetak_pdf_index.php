            ...
            <div class="card card-warning card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link"  href="<?php echo site_url('/ortu/prenatal/'); ?>" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Prenatal</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"   href="<?php echo site_url('/cetak_pdf/cetak_pdf/'); ?>" role="tab" aria-controls="custom-tabs-one-settings" aria-selected="false">Unduh PDF</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Unduh PDF</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title"> Unduh PDF</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-6 col-form-label">Form Pendaftaran</label>
                    <div class="col-sm-6">
                      <a href="<?php echo site_url('/cetak_pdf/P2/pdf/'.$this->session->daftar['id_pendaftaran']) ?>" target="new_window()" class="btn btn-primary">Unduh</a>
                    </div>
                  </div>
