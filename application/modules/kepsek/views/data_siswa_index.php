      ...
      <div class="row">
        <div class="col-12">
          <!-- /.card -->
            ...
            <td align="center">
              <a href="<?php echo site_url('/kepsek/data_siswa/laporan_anak/'.$record->no_induk); ?>" class="btn-sm btn-primary">Lihat Data</a>
            </td>
            <td align="center">
              <a href="<?php echo site_url('/kepsek/data_siswa/edit/'.$record->no_induk); ?>" class="btn-sm btn-warning">Lihat Formulir Pendaftaran</a>
            </td>
          <!-- 
						<td align="center">
							<a href="<?php //echo site_url('/kepsek/data_siswa/delete/'.$record->no_induk); ?>" class="btn-sm btn-danger">Hapus Data</a>
						</td> 
          -->
					</tr>
