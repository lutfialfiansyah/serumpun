		...
		<tbody>
			...
			?>
					<tr>
						...
						<td align="center">
							<a href="<?php echo site_url('/kepsek/data_siswa/edit/'.$record->id_pendaftaran); ?>" title="Edit Data"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
						</td>
						<td align="center">
							<a href="<?php echo site_url('/kepsek/data_siswa/delete/'.$record->id_pendaftaran); ?>" title="Hapus Data"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
						</td>
					</tr>
			<?php 
				endforeach;
