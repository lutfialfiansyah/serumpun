        ...
        <div class="col-12">
          <!-- /.card -->
            ...
            <!-- <div class="card-header">
              <a href="<?php //echo site_url('/kepsek/observasi_tenaga_ahli/add'); ?>" class="btn-sm btn-primary"> + Tambah Data </a>
            </div> -->
          ...
          <tr>
            ...
            <td align="center">
              <form action="<?php echo site_url('/kepsek/pilih_tenaga_ahli/form/'); ?>" method="post">
                <div hidden="true"><input type="text" name="id_pendaftaran" value="<?php echo $record->id_pendaftaran; ?>"></div>
                <button type="submit" <?= ($record->status_anak == 'Tidak Diterima') ? 'class="btn btn-secondary" disabled="true"' : 'class="btn-sm btn-primary" ' ;?>>Pilih Tenaga Ahli</button>
              </form>
            </td>
          </tr>
