...
<!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2"> 
          <div class="col-sm-6">
            <h1>Pilih PPI Siswa</h1> 
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"> Pilih PPI Siswa</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <!-- /.card -->
            ...
            <!-- <div class="card-header">
              <a href="<?php //echo site_url('/kepsek/observasi_kepala_sekolah/add'); ?>" class="btn-sm btn-primary"> + Tambah Data </a>
            </div> -->
          ...
          <tr>
            ...
            <td align="center">
              <a href="<?php echo site_url('/kepsek/penerimaan_siswa/edit/'.$record->id_pendaftaran); ?>" class="btn-sm btn-warning">Lihat Detail</a>
            </td>
            <td align="center">
              <button onclick="window.location.href='<?php echo site_url('/kepsek/observasi_kepsek/add/'.$record->id_pendaftaran); ?>'" <?= ($record->status_anak != 'Diterima') ? 'class="btn-sm btn-secondary" disabled="true" style="cursor: not-allowed;"' : 'class="btn-sm btn-primary" ' ;?> >Tambah PPI</button>
            </td>
          </tr>
