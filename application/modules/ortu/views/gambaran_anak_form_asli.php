<h3 class="page-header">Form Gambaran Anak</h3>
<div class="actions">
...
<?php echo form_open($action, array ('class' => 'form-horizontal row-form')); ?>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label input-sm">Gambaran Anak  </label>
		<div class="col-sm-4">
			<textarea rows="4" cols="50" name="ket_anak" placeholder="Jelaskan dengan detail anak anda di sini..."></textarea>
		</div>
	</div>
