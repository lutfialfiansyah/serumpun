<!-- ./row -->
            ...
            <div class="card card-warning card-tabs"> 
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"   href="<?php echo site_url('/ortu/harapan_ortu/'); ?>" role="tab" aria-controls="custom-tabs-one-settings" aria-selected="true">Harapan Kemampuan Yang Perlu Dikembangkan</a>
                  </li>
                  <li class="nav-item">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Formulir Harapan Orang Tua</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Harapan Orang Tua</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Harapan Orang Tua</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <?php echo form_open($action, array('class' => 'form-horizontal row-form')); ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Harapan Orang Tua</label>
                    <div class="col-sm-9">
                      <textarea class="form-control"  name="ket_harapan" placeholder="Harapan yang diinginkan..." >
                        <?php if(isset($harapan_ortu->ket_harapan)) echo $harapan_ortu->ket_harapan; ?>
                      </textarea>
                    </div>
                  </div>
