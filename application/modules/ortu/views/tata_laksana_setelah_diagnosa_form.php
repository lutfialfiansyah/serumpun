<!-- ./row -->
            ...
            <div class="card card-warning card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"   href="<?php echo site_url('/ortu/tata_laksana_setelah_diagnosa/'); ?>" role="tab" aria-controls="custom-tabs-one-settings" aria-selected="true">Tata Laksana Sejak Didiagnosa</a>
                  </li>
                  <li class="nav-item">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Formulir Tata Laksana Diagnosa</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Tata laksana setelah didiagnosa</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <?php echo form_open($action, array('class' => 'form-horizontal row-form')); ?>
				...
				<div class="form-group">
						<div class="col-sm-12">
							<textarea class="textarea" name="data_tata_laksana_setelah_diagnosa" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
            <?php if ($tata_laksana_setelah_diagnosa->data_tata_laksana_setelah_diagnosa) : echo $tata_laksana_setelah_diagnosa->data_tata_laksana_setelah_diagnosa ?>
            <?php else : ?>
