<!-- ./row -->
            ...
            <div class="card card-warning card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"  href="<?php echo site_url('/ortu/imunisasi/'); ?>" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="true">Imunisasi</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="row mb-2">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Jenis imunisasi yang diberikan kepada anak</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
  ...
  <div class="form-group">
    <div class="col-sm-12">
      <textarea class="textarea" name="data_imunisasi" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">

            <?php if ($imunisasi->data_imunisasi) : echo $imunisasi->data_imunisasi; ?>
            <?php  else : ?>
