            ...
            <div class="card card-warning card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"  href="<?php echo site_url('/ortu/rekam_medis/'); ?>" role="tab" aria-controls="custom-tabs-one-messages" aria-selected="true">Upload Data Rekam Medis</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="row mb-2">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Upload Data Rekam Medis</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <?php echo form_open_multipart($action, array('class' => 'form-horizontal row-form')); ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="nama_dokter" value="<?= $this->session->has_userdata('daftar') ? $rekam_medis->nama_dokter : '';?>"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="nama_rs" value="<?= $this->session->has_userdata('daftar') ? $rekam_medis->nama_rs : '';?>"/>
                    </div>
                  </div>

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Jabatan Dokter</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="jabatan_dokter" value="<?= $this->session->has_userdata('daftar') ? $rekam_medis->jabatan_dokter : '';?>"/>
                    </div>
                  </div>

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">File Rekam Medis (PDF)</label>
                    <div class="col-sm-3">
                      <input class="form-control input-sm" type="file" name="userfile" />
                    </div>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" value="<?= $this->session->has_userdata('daftar') ? $rekam_medis->file_rekam_medis : '';?>" readonly/>
                    </div>
                  </div>
