<!-- ./row -->
            ...
            <div class="card card-warning card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link"  href="<?php echo site_url('/ortu/imunisasi/'); ?>" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="true">Imunisasi</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"  href="<?php echo site_url('/ortu/kegiatan_rutin_anak/'); ?>" role="tab" aria-controls="custom-tabs-one-messages" aria-selected="false">Jadwal Kegiatan Rutin Anak</a>
                  </li>
                  <li class="nav-item">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Kegiatan Rutin Anak</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Kegiatan Rutin Anak</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Jadwal Kegiatan Rutin Anak</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<div class="form-group">
		<div class="col-sm-12">
			<textarea class="textarea" name="data_kegiatan_rutin_anak" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
            <?php if ($kegiatan_rutin_anak->data_kegiatan_rutin_anak) : echo $kegiatan_rutin_anak->data_kegiatan_rutin_anak ?>
            <?php else : ?>
