            ...
            <div class="card card-warning card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active"   href="<?php echo site_url('/ortu/kartu_keluarga/'); ?>" role="tab" aria-controls="custom-tabs-one-settings" aria-selected="true">Upload Data Kartu Keluarga</a>
                  </li>
                  <li class="nav-item">
          ...
          <div class="row mb-2">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Upload Data Kartu Keluarga</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <?php echo form_open_multipart($action, array('class' => 'form-horizontal row-form')); ?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="no_kk" value="<?= $this->session->has_userdata('daftar') ? $kartu_keluarga->no_kk : '';?>"/>
                    </div>
                  </div>

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">File Kartu Keluarga (PDF)</label>
                    <div class="col-sm-3">
                      <input class="form-control input-sm" type="file" name="userfile" />
                    </div>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" value="<?= $this->session->has_userdata('daftar') ? $kartu_keluarga->file_kartu_keluarga : '';?>" readonly/>
                    </div>
                  </div>
