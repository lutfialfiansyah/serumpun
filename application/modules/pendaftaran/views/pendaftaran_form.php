		        ...
		        <div class="col-lg-6">
		            <div class="card m-3 p-3">
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-8">
							  <input class="form-control input-sm" type="text" name="anak_ke" placeholder="Anak ke" value="<?php if($pendaftaran->id_pendaftaran) echo $pendaftaran->anak_ke; ?>" required />
							</div>
						</div>
					    <div class="form-group">
					        <label class="col-sm-4 control-label input-sm">Jumlah saudara</label>
							<div class="col-sm-8">
							  <input class="form-control input-sm" type="text" name="jum_saudara" placeholder="Jumlah Saudara" value="<?php if($pendaftaran->id_pendaftaran) echo $pendaftaran->jum_saudara; ?>" required />
							</div>
						</div>
						<div class="form-group" <?php echo ($pendaftaran->id_pendaftaran) ? '' : 'style="display: none;"' ?>>
							...
							<div class="col-sm-8">
								<input class="form-control input-sm" type="text" name="status_anak" placeholder="Status Pendaftaran" <?php echo ($pendaftaran->id_pendaftaran) ? 'value="'.$pendaftaran->status_anak.'" readonly' : 'value="'.'Proses Daftar'.'"' ?>/>
							</div>
						</div>
		            </div>
		            <!-- /.card -->
