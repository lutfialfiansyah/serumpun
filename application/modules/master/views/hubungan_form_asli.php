<h3 class="page-header">Form Hubungan Keluarga</h3>
<div class="actions">
...
<?php echo form_open($action, array('class' => 'form-horizontal row-form')); ?>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label input-sm">Hubungan Keluarga</label>
		<div class="col-sm-4">
			<input class="form-control input-sm" type="text" name="hubungan" placeholder="Hubungan Keluarga" value="<?php echo $hubungan->hubungan; ?>"  required />
		</div>
	</div>
