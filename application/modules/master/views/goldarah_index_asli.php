<h3 class="page-header">Golongan Darah</h3>
<div class="actions">
		...
		<tbody>
			...
			?>
					<tr>
						...
						<td align="center">
							<a href="<?php echo site_url('/master/goldarah/edit/'.$record->id_goldarah); ?>" title="Edit Data"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
						</td>
					</tr>
			<?php 
					$no++;
