<h3 class="page-header">Kecamatan</h3>
<div class="actions">
		...
		<tbody>
			...
			?>
					<tr>
						...
						<td align="center">
							<a href="<?php echo site_url('/master/kecamatan/edit/'.$record->id_kecamatan); ?>" title="Edit Data"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
						</td>
					</tr>
			<?php 
					$no++;
