<h3 class="page-header">Form Pemeriksa</h3>
<div class="actions">
...
<?php echo form_open($action, array('class' => 'form-horizontal row-form')); ?>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label input-sm">Pemeriksa</label>
		<div class="col-sm-4">
			<input class="form-control input-sm" type="text" name="pemeriksa" placeholder="Pemeriksa" value="<?php echo $pemeriksa->pemeriksa; ?>"  required />
		</div>
	</div>
