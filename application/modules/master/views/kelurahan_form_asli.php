...
$().ready(function() {
	...
	$('[name=kecamatan_id]').select2({width: '100%'}); 

});	
</script>

<h3 class="page-header">Form Kelurahan</h3>
<div class="actions">
...
<div class="form-group">
		<label class="col-sm-2 control-label input-sm">Kode Kelurahan</label>
		<div class="col-sm-4">
			<input class="form-control input-sm" type="text" name="id_kelurahan" placeholder="Id kelurahan" value="<?php echo $kelurahan->id_kelurahan; ?>"  required />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input class="form-control input-sm" type="text" name="kelurahan" placeholder="kelurahan" value="<?php echo $kelurahan->kelurahan; ?>"  required />
		</div>
	</div>
