<h3 class="page-header">Form Jenis Persalinan</h3>
<div class="actions">
...
<?php echo form_open($action, array('class' => 'form-horizontal row-form')); ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input class="form-control input-sm" type="text" name="persalinan" placeholder="Jenis Persalinan" value="<?php echo $persalinan->persalinan; ?>"  required />
		</div>
	</div>
