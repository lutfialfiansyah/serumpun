        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <a href="<?php echo site_url('/master/kelurahan/add'); ?>" class="btn-sm btn-primary"> + Tambah Data </a>
            </div>
            <!-- /.card-header -->
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td align="center">
                          <a href="<?php echo site_url('/master/kelurahan/edit/'.$record->id_kelurahan); ?>" class="btn-sm btn-warning">Edit Data</a>
                          <a href="<?php echo site_url('/master/kelurahan/delete/'.$record->id_kelurahan); ?>" class="btn-sm btn-danger">Hapus Data</a>
                        </td>
                      </tr>
                  <?php 
                      $no++;
