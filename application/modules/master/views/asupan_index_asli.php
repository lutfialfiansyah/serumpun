<h3 class="page-header">Asupan</h3>
<div class="actions">
		...
		<tbody>
			...
			?>
					<tr>
						...
						<td align="center">
							<a href="<?php echo site_url('/master/asupan/edit/'.$record->id_asupan); ?>" title="Edit Data"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
						</td>
					</tr>
			<?php 
					$no++;
