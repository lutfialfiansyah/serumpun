<h3 class="page-header">Terapi</h3>
<div class="actions">
		...
		<tbody>
			...
			?>
					<tr>
						...
						<td align="center">
							<a href="<?php echo site_url('/master/terapi/edit/'.$record->id_terapi); ?>" title="Edit Data"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
						</td>
					</tr>
			<?php 
					$no++;
