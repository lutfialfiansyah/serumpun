<h3 class="page-header">Form Kondisi Bayi</h3>
<div class="actions">
...
<?php echo form_open($action, array('class' => 'form-horizontal row-form')); ?>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label input-sm">Kondisi Bayi</label>
		<div class="col-sm-4">
			<input class="form-control input-sm" type="text" name="konbayi" placeholder="Kondisi Bayi" value="<?php echo $konbayi->konbayi; ?>"  required />
		</div>
	</div>
