<h3 class="page-header">Form Penyakit Khusus</h3>
<div class="actions">
...
<?php echo form_open($action, array('class' => 'form-horizontal row-form')); ?>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label input-sm">Penyakit Khusus</label>
		<div class="col-sm-4">
			<input class="form-control input-sm" type="text" name="penyakit" placeholder="Penyakit Khusus" value="<?php echo $penyakit->penyakit; ?>"  required />
		</div>
	</div>
